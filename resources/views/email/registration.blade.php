...
<br><br>
Thank you for participating in the 2019 ASAIHL International Conference! Please confirm your participation by paying your registration fee amounting to {{ $profile->citizenship == 'LOCAL' ? '₱' : '$' }}{{ $price * ($count + 1) }}.
<br><br>
...
@endif
<br>
Paypal: <strong>ueccssrnd</strong><br><br>
